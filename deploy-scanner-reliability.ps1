...
if (-not (Test-Path -LiteralPath $archive)) {
  throw "Deployment archive is missing: $archive"
}

$remoteArchive = "/tmp/fgp-scanner-reliability-v3.tar.gz"
...
if ($sshExit -ne 0) { throw "Remote deployment or audit failed. Full log: $log" }
