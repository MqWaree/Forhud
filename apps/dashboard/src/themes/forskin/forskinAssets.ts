...
export const forskinAssets = {
  ...
  frames: {
    ...
    organic: `${root}/frames/frame-organic-forskin-v4.webp`,
  ...
  ornaments: {
    chainCorner: `${root}/ornaments/chain-top-right-v4.webp`,
    ...
    medallion: `${root}/ornaments/forhud-forevig-medallion-v4.webp`,
    mug: `${root}/ornaments/forskin-mug-blank-v4.webp`,
    ...
    skinTendril: `${root}/ornaments/tendril-skin-v4.webp`,
  },
  plaques: {
    rustedSmall: `${root}/plaques/plaque-rusted-small.webp`,
    rustedWide: `${root}/plaques/plaque-rusted-wide.webp`,
    torn: `${root}/plaques/torn-warning-plaque-v4.webp`,
    graffiti: `${root}/plaques/graffiti-sticker-tall-v4.webp`,
